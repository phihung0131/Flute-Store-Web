            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="text-center bg-gray-50 p-6 rounded-lg transition-all duration-300 hover:shadow-lg">
                ...
                <p className="text-gray-600">
                  Cam kết sản xuất những cây sáo chất lượng cao nhất, đáp ứng
                  tiêu chuẩn quốc tế.
                </p>
              </div>
              <div className="text-center bg-gray-50 p-6 rounded-lg transition-all duration-300 hover:shadow-lg">
                ...
                <p className="text-gray-600">
                  Không ngừng cải tiến và phát triển sản phẩm, kết hợp truyền
                  thống với hiện đại.
                </p>
              </div>
              <div className="text-center bg-gray-50 p-6 rounded-lg transition-all duration-300 hover:shadow-lg">
                ...
                <p className="text-gray-600">
                  Làm việc với tình yêu và sự tận tâm với âm nhạc, truyền cảm
                  hứng cho thế hệ mới.
                </p>
              </div>
            </div>
