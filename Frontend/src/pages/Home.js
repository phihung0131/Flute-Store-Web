...
import ProductNewList from "../components/Customer/Home/ProductNewList";
      ...
      <div className="banner">
        <div className="relative">
          ...
          <div className="relative min-h-[350px] flex flex-col items-center justify-center p-6 text-white">
            ...
            <button
              className="mt-8 px-6 py-3 border-2 border-solid border-white rounded-lg hover:bg-white hover:text-black font-bold"
