      ...
      <header className="flex shadow-sm py-3 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
        <div className="flex flex-wrap items-center justify-between lg:gap-y-4 gap-y-6 gap-x-4 w-full">
          ...
          >
            ...
            <ul className="lg:flex lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50 pt-3">
              <li
                className={`max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:after:absolute lg:after:bg-black ${
                  activeTab === "dashboard" ? "lg:after:w-full" : "lg:after:w-0"
                } lg:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300`}
              >
                <a
                  href="#"
                  className="text-black block text-[15px] no-underline flex items-center"
                  onClick={() => handleView("/admins", "dashboard")}
                >
                  Bảng điều khiển
                </a>
              </li>
              <li
                className={`max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:after:absolute lg:after:bg-black ${
                  activeTab === "users" ? "lg:after:w-full" : "lg:after:w-0"
                } lg:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300`}
              >
                <a
                  href="#"
                  className="text-black block text-[15px] no-underline flex items-center"
                  onClick={() => handleView("/admins/manage-users", "users")}
                >
                  Người dùng
                </a>
              </li>
              <li
                className={`max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:after:absolute lg:after:bg-black ${
                  activeTab === "products" ? "lg:after:w-full" : "lg:after:w-0"
                } lg:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300`}
              >
                <a
                  href="#"
              ...
              <li
                className={`max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:after:absolute lg:after:bg-black ${
                  activeTab === "orders" ? "lg:after:w-full" : "lg:after:w-0"
                } lg:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300`}
              >
                <a
                  href="#"
                  className="text-black block text-[15px] no-underline flex items-center"
                  onClick={() => handleView("/admins/manage-orders", "orders")}
                >
                  Đơn hàng
                </a>
              </li>
              <li
                className={`max-lg:border-b max-lg:py-3 max-lg:px-3 relative lg:after:absolute lg:after:bg-black ${
                  activeTab === "reviews" ? "lg:after:w-full" : "lg:after:w-0"
                } lg:after:h-[2px] lg:after:block lg:after:top-6 lg:after:transition-all lg:after:duration-300`}
              >
                <a
                  href="#"
                        ...
                        <ul className="space-y-1.5 pl-0">
                          ...
                          <li>
                            <a
                              href="#"
                              onClick={() =>
                                handleView("admin-history", "admin-history")
                              }
                              className="text-sm text-gray-500 hover:text-black"
                            >
                              Admin History
